...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func addToContext(name: String, photo: UIImage?,
                      notes: String?, email: String?, phone: String?, category: String?) -> PersonMO {
    ...
    func updateToContext(person: PersonMO, name: String,photo: UIImage?,notes: String?, email: String?, phone: String?, category: String?) {
        person.name = name
        if let photo = photo {
            person.photo = UIImagePNGRepresentation(photo) as NSData?
        }
